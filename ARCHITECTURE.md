...
app_tactics_coach/
  ...
  src/
    ...
    app.css               all styles (dark theme, layout, tabs, recognition, save) (M1+)
    ...
    motifs.js             motif definitions + example FENs (M3)
    storage.js            localStorage CRUD: positions + attempts (M6, M7)
  public/
